...
const { addOrder } = useOrder();
  const items = [
    { name: 'Chicken 65', image: '/images/Chicken65.jpeg', price: '₹180' },
    { name: 'Mutton Seekh Kebab', image: '/images/MuttonSeekh.jpg', price: '₹250' },
    { name: 'Fish Fingers', image: '/images/FishFingers.jpg', price: '₹220' }
  ];
 ...
 const openForm = (item) => {
  ...
  return (
    <div className="category-page">
      <h2 className="text-center mb-4">NonVegetarianStarters</h2>
