...
export default function Drinks() {
 ...
 const { addOrder } = useOrder();
  const items = [
    { name: 'Fresh Lime Soda', image: '/images/drinks/Fresh Lime Soda.jpeg', price: '₹60' },
    { name: 'Mango Lassi', image: '/images/drinks/MangoLassi.jpeg', price: '₹80' },
    { name: 'Cold Coffee', image: '/images/drinks/ColdCoffee.jpeg', price: '₹90' }
  ];
