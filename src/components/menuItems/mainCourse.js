...
const { addOrder } = useOrder(); 
  const items = [
    ...
    { name: 'Chicken Curry', price: '₹250', image: '/images/maincourse/ChickenCurry.jpeg' },
     { name: 'Chicken biriyani', price: '₹250', image: '/images/maincourse/Chickenbiriyani.jpg' },
      { name: 'mutton biriyani', price: '₹250', image: '/images/muttonbiriyani.jpg' },
    { name: 'Dal Makhani', price: '₹190', image: '/images/DalMakhani.jpeg' }
  ];
  ...
  return (
    <div className="category-page">
      <h2 className="text-center mb-4">MainCourse</h2>
